...
import BaseCommand from './bcommand.class.js'
import RookEmbed from '../embed/rembed.class.js'
import SlimEmbed from '../embed/rslimbed.class.js'
 ...
 * @public
 */
let command = class RookCommand extends BaseCommand {
  /**
  ...
  /**
   * @type {GuildChannel} Channel to send embeds to
   */
   ...
   * @returns {Promise.<GuildChannel>} Found channel object
   */
